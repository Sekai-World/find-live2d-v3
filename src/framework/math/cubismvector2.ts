...
export namespace Live2DCubismFramework {
    ...
    export class CubismVector2 {
        ...
        public add(vector2: CubismVector2): CubismVector2 {
            ...
            ret.x = (this.x as any) + (vector2.x as any);
            ret.y = (this.y as any) + (vector2.y as any);
            return ret;
        }
        ...
        public getLength(): number {
          return Math.sqrt((this.x as any) * (this.x as any) + (this.y as any) * (this.y as any));
        }
        ...
        public getDistanceWith(a: CubismVector2): number {
          return Math.sqrt((((this.x as any) - (a.x as any)) * ((this.x as any) - (a.x as any))) + (((this.y as any) - (a.y as any)) * ((this.y as any) - (a.y as any))));
        }
        ...
        public dot(a: CubismVector2): number {
          return ((this.x as any) * (a.x as any)) + ((this.y as any) * (a.y as any));
        }
        ...
        public normalize(): void {
          const length: number = Math.pow(((this.x as any) * (this.x as any)) + ((this.y as any) * (this.y as any)), 0.5);

          this.x = (this.x as any) / length;
          this.y = (this.y as any) / length;
        }
