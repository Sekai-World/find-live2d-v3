...
export namespace Live2DCubismFramework {
    ...
    export class CubismEyeBlink {
         ...
         */
        public static readonly CloseIfZero: boolean = true;
        /**
         * インスタンスを作成する
         ...
         */
      public static create(modelSetting: ICubismModelSetting = null as any): CubismEyeBlink {
        ...
        public _blinkingState: number;             // 現在の状態
        public _parameterIds: csmVector<CubismIdHandle>; // 操作対象のパラメータのIDのリスト
        public _nextBlinkingTime: number;          // 次のまばたきの時刻[秒]
        public _stateStartTimeSeconds: number;     // 現在の状態が開始した時刻[秒]
        public _blinkingIntervalSeconds: number;   // まばたきの間隔[秒]
        public _closingSeconds: number;            // まぶたを閉じる動作の所要時間[秒]
        public _closedSeconds: number;             // まぶたを閉じている動作の所要時間[秒]
        public _openingSeconds: number;            // まぶたを開く動作の所要時間[秒]
