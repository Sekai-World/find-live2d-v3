...
export namespace Live2DCubismFramework {
    ...
    export class CubismPose {
        ...
        public _partGroups: csmVector<PartData>; // パーツグループ
        public _partGroupCounts: csmVector<number>;         // それぞれのパーツグループの個数
        public _fadeTimeSeconds: number;           // フェード時間[秒]
        public _lastModel: CubismModel;            // 前回操作したモデル
    ...
    export class PartData {
      ...
      public partId: CubismIdHandle = undefined as any;   // パーツID
        public parameterIndex: number; // パラメータのインデックス
        public partIndex: number;  // パーツのインデックス
        public link: csmVector<PartData>;   // 連動するパラメータ
        /**
         * コンストラクタ
         */
        ...
        public clone(): PartData {
            ...
            for (const ite: iterator<PartData> = this.link.begin(); ite.notEqual(this.link.end()); ite.increment()) {
