...
export namespace Live2DCubismFramework {
  ...
  export class CubismClippingManager_WebGL {
    ...
    public gl: WebGLRenderingContext; // WebGLレンダリングコンテキスト
  ...
  export class CubismShader_WebGL {
    ...
    public gl: WebGLRenderingContext; // webglコンテキスト
  ...
  export class CubismShaderSet {
    public shaderProgram: WebGLProgram; // シェーダープログラムのアドレス
    public attributePositionLocation: GLuint; // シェーダープログラムに渡す変数のアドレス（Position）
    public attributeTexCoordLocation: GLuint; // シェーダープログラムに渡す変数のアドレス（TexCoord）
    public uniformMatrixLocation: WebGLUniformLocation; // シェーダープログラムに渡す変数のアドレス（Matrix）
    public uniformClipMatrixLocation: WebGLUniformLocation; // シェーダープログラムに渡す変数のアドレス（ClipMatrix）
    public samplerTexture0Location: WebGLUniformLocation; // シェーダープログラムに渡す変数のアドレス（Texture0）
    public samplerTexture1Location: WebGLUniformLocation; // シェーダープログラムに渡す変数のアドレス（Texture1）
    public uniformBaseColorLocation: WebGLUniformLocation; // シェーダープログラムに渡す変数のアドレス（BaseColor）
    public uniformChannelFlagLocation: WebGLUniformLocation; // シェーダープログラムに渡す変数のアドレス（ChannelFlag）
  }
